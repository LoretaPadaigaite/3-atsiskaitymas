...
console.group('Literal types - užduotys');
{
  ...
  console.group("1. Sukurkite 5 didžiausių Lietuvos miestų išvardinimą.");
  {
    ...
    const city3: LithuanianCity = LithuanianCity.Vilnius;
    const city4: LithuanianCity = LithuanianCity.Panevezys;
    const city5: LithuanianCity = LithuanianCity.Siauliai;
  ...
  {
    const largestCountries: LargestCountries[] = [LargestCountries.China, LargestCountries.Pakistan, LargestCountries.Indonesia, LargestCountries.India, LargestCountries.UnitedStates];
