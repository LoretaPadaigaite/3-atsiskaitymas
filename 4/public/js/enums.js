...
console.group('Literal types - užduotys');
{
    ...
    console.group("1. Sukurkite 5 didžiausių Lietuvos miestų išvardinimą.");
    {
        ...
        const city3 = LithuanianCity.Vilnius;
        const city4 = LithuanianCity.Panevezys;
        const city5 = LithuanianCity.Siauliai;
    ...
    {
        const largestCountries = [LargestCountries.China, LargestCountries.Pakistan, LargestCountries.Indonesia, LargestCountries.India, LargestCountries.UnitedStates];
