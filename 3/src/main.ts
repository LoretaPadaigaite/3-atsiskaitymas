...
{
  function lastIndexOfArr(arr: any[]): void {
...
{
  function indexInRow(arr: any[]): void {
...
{
  function arrMeaningInRow(arr: any[]): void {
...
// [2] => reikšmė
{
  function arrIndexPlusMeaning(arr: any[]): void {
...
{
  function arrIndexReverse(arr: any[]): void {
...
{
  function arrIndexOneRow(arr: any[]): void {
...
{
  function arrMeaningInOneRow (arr: any[]): void {
    const res = arr.join(' ');
    console.log(res);
    // console.log(...arr);
  }
...
//  [0]=>17, [1]=>8, [2]=>88 ..
{
  function arrIndexAndMeaningInOneRow (arr: any[]): void {
...
{
  function arrayElementsAndIndexMultiplication (arr: number[]): number[] {
...
{
  function returnPositiveElementArrOfInitialArray (arr: number[]): number[] {
...
{
  function returnNegativeElementArrOfInitialArray(arr: number[]): number[] {
    return arr.filter((x) => x <= 0);
  }
...
{
  function returnEqualElementArrOfInitialArray(arr: number[]): number[] {
...
{
  function returnOddElementArrOfInitialArray(arr: number[]): number[] {
...
{
  function returnArrayMakeAllElementPositive(arr: number[]): number[] {
